  ...
  'tulum': {
    ...
    // dans photos/tulum/ (grande version) et photos/tulum/thumbs/ (miniature 220x160).
      { src: 'photos/tulum/01.jpg', thumb: 'photos/tulum/thumbs/01.jpg',
       alt: "Portrait allongé sur une chaise longue, sur le sable",
       pos: { u: 100, v: 118 },
        caption: { fr: '', en: '', es: '' } },

       { src: 'photos/tulum/02.jpg', thumb: 'photos/tulum/thumbs/02.jpg',
      alt: "Plage de sable blanc bordée de palmiers, face à la mer turquoise",
      pos: { u: 92, v: 117, dir: 90 },
         caption: { fr: '', en: '', es: '' } },

    { src: 'photos/tulum/03.jpg', thumb: 'photos/tulum/thumbs/03.jpg',
         alt: "Sur un sentier de sable bordé de végétation tropicale",
         pos: { u: 30, v: -100, dir: 90 },
        caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/04.jpg', thumb: 'photos/tulum/thumbs/04.jpg',
         alt: "Bâtiment de pierre à deux massifs et colonne centrale, ruines de Tulum",
         pos: { u: 15, v: 2, dir: 90 },
        caption: { fr: '', en: '', es: '' } },

       { src: 'photos/tulum/05.jpg', thumb: 'photos/tulum/thumbs/05.jpg',
        alt: "Chemin longeant un muret, avec El Castillo et le temple du Dieu du Vent au bord de la falaise",
        pos: { u: 90, v: 30, dir: 150 },
        caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/06.jpg', thumb: 'photos/tulum/thumbs/06.jpg',
        alt: "Pelouse au bord de la falaise et mer des Caraïbes à l'horizon",
        pos: { u: 55, v: 85, dir: 95 },
       caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/07.jpg', thumb: 'photos/tulum/thumbs/07.jpg',
        alt: "Pelouse, palmiers et angle d'un grand édifice, un temple au loin",
        pos: { u: 40, v: 60, dir: 250 },
        caption: { fr: '', en: '', es: '' } },

       { src: 'photos/tulum/08.jpg', thumb: 'photos/tulum/thumbs/08.jpg',
        alt: "Promeneur sur la plage, sac au dos, face à la mer",
        pos: { u: -45, v: 115, dir: 0 },
        caption: { fr: '', en: '', es: '' } },

   { src: 'photos/tulum/09.jpg', thumb: 'photos/tulum/thumbs/09.jpg',
        alt: "El Castillo vu depuis la pelouse, derrière un oranger",
        pos: { u: -5, v: -30, dir: 85 },
        caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/10.jpg', thumb: 'photos/tulum/thumbs/10.jpg',
        alt: "Long édifice de pierre bordé d'un sentier et d'une corde",
        pos: { u: -25, v: -5, dir: 60 },
       caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/11.jpg', thumb: 'photos/tulum/thumbs/11.jpg',
        alt: "Temple à degrés et bâtiment sous toit de palme, ruines de Tulum",
        pos: { u: -15, v: 35, dir: 333 },
        caption: { fr: '', en: '', es: '' } },

       { src: 'photos/tulum/12.jpg', thumb: 'photos/tulum/thumbs/12.jpg',
       alt: "Ruines à colonnes et murets bas, plantes violettes au premier plan",
       pos: { u: 0, v: 5, dir: 20 },
        caption: { fr: '', en: '', es: '' } },

       { src: 'photos/tulum/13.jpg', thumb: 'photos/tulum/thumbs/13.jpg',
         alt: "Escalier de bois descendant vers la crique et la plage",
         pos: { u: 105, v: 108, dir: 100 },
        caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/14.jpg', thumb: 'photos/tulum/thumbs/14.jpg',
        alt: "Portrait au chapeau de paille sur la pelouse, entre les palmiers",
        pos: { u: -45, v: -35, dir: 45 },
       caption: { fr: '', en: '', es: '' } },

       { src: 'photos/tulum/15.jpg', thumb: 'photos/tulum/thumbs/15.jpg',
         alt: "Iguane sur la pierre devant les colonnes du Templo de las Pinturas",
         pos: { u: 15, v: 10, dir: 90 },
         caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/16.jpg', thumb: 'photos/tulum/thumbs/16.jpg',
       alt: "Colonnes et dalles de pierre de la galerie du Templo de las Pinturas",
       pos: { u: 16, v: 12, dir: 80 },
         caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/17.jpg', thumb: 'photos/tulum/thumbs/17.jpg',
        alt: "Jeune cocotier dans le sable blanc",
        pos: { u: 88, v: 119 },
       caption: { fr: '', en: '', es: '' } },

   { src: 'photos/tulum/18.jpg', thumb: 'photos/tulum/thumbs/18.jpg',
    alt: "Palmier et parasol sous un ciel chargé, frégates en vol",
    pos: { u: 90, v: 117, dir: 0 },
     caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/19.jpg', thumb: 'photos/tulum/thumbs/19.jpg',
        alt: "Frégates dans un ciel d'orage au-dessus des palmiers",
        pos: { u: 92, v: 118, dir: 350 },
        caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/20.jpg', thumb: 'photos/tulum/thumbs/20.jpg',
        alt: "Cycliste sur la route asphaltée qui mène au site",
        pos: { u: 2, v: -190, dir: 90 },
     caption: { fr: '', en: '', es: '' } },

   { src: 'photos/tulum/21.jpg', thumb: 'photos/tulum/thumbs/21.jpg',
        alt: "Cycliste sur la route bordée d'arbres, camion-navette au fond",
        pos: { u: -2, v: -160, dir: 90 },
        caption: { fr: '', en: '', es: '' } },

      { src: 'photos/tulum/22.jpg', thumb: 'photos/tulum/thumbs/22.jpg',
        alt: "Portrait à vélo, mouvement flou, sur la route du site",
        pos: { u: 0, v: -140, dir: 0 },
   caption: { fr: '', en: '', es: '' } },
